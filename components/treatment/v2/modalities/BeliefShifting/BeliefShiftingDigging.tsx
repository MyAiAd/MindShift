...
export default function BeliefShiftingDigging({
  sessionId,
  userId,
  messages,
  currentStep,
  ...
  const handleMethodSelection = async (method: string) => {
    console.log('🔍 DEBUG: BeliefShiftingDigging handleMethodSelection called with:', method);
    await onSendMessage(method);
  };

  // Belief Shifting specific digging deeper steps
  const shouldShowBeliefDiggingButtons = () => {
    const beliefDiggingSteps = [
      'belief_digging_deeper_start',
      'belief_scenario_check_1',
      'belief_scenario_check_2', 
      'belief_scenario_check_3',
      'belief_anything_else_check_1',
      'belief_anything_else_check_2',
      'belief_anything_else_check_3'
    ];
    
    if (!beliefDiggingSteps.includes(currentStep)) return false;
  ...
  // Render Belief Shifting digging deeper buttons
  if (shouldShowBeliefDiggingButtons()) {
    return (
  ...
  // Render Belief Shifting digging method selection
  if (shouldShowBeliefDiggingMethodButtons()) {
    return (
      <div className="flex space-x-3 max-w-4xl w-full">
        {/* Undo Button */}
        <div className="flex items-center">
        ...
        <div className="flex flex-col space-y-4 flex-1">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">
              Choose your method to clear this belief issue:
            </h3>
