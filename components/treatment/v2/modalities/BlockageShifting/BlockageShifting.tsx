...
interface BlockageShiftingProps extends ModalityComponentProps {
  // Additional props specific to Blockage Shifting
}
...
export default function BlockageShifting({
  ...
  // Helper function to determine if we should show the choose_method buttons for Blockage Shifting
  const shouldShowChooseMethodButtons = () => {
    // Blockage Shifting should NOT show method selection buttons on choose_method step
    // That step is only for problem-clearing methods when PROBLEM work type is selected
    return false;
  };

  // Render Blockage Shifting specific Yes/No UI
  if (isBlockageShiftingYesNoStep()) {
    return (
  ...
  // Method selection for Blockage Shifting (when part of problem-clearing methods)
        ...
        <div className="flex flex-col space-y-4 flex-1">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">
              Choose your Blockage Shifting method:
            </h3>
