...
export default function IdentityShifting({
  ...
  const isIdentityShiftingYesNoStep = () => {
    const identityShiftingYesNoSteps = [
      ...
      'identity_step_3_intro',          // Identity step 3 intro
    ];
  ...
  // Method selection for Identity Shifting (when part of problem-clearing methods)
        ...
        <div className="flex flex-col space-y-4 flex-1">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">
              Choose your Identity Shifting method:
            </h3>
