...
interface ProblemShiftingProps extends ModalityComponentProps {
  ...
  showEmotionConfirmation?: boolean;
}
...
export default function ProblemShifting({
  ...
  // Check if we should show emotion confirmation buttons
  const shouldShowEmotionConfirmation = () => {
    return showEmotionConfirmation && currentStep === 'work_type_description';
  };

  // Render emotion confirmation UI
  if (shouldShowEmotionConfirmation()) {
    return (
