        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[
            ...
            <button
              ...
              disabled={isLoading}
              className="p-4 text-left border border-border rounded-lg hover:border-primary hover:bg-primary/10 transition-colors disabled:opacity-50"
            >
              <div className="font-medium text-foreground">{method.name}</div>
              <div className="text-sm text-muted-foreground dark:text-muted-foreground mt-1">{method.description}</div>
            </button>
          ))}
        </div>
      )}
      ...
      {isBeliefShiftingYesNoMaybeStep() && (
        <div className="flex space-x-2">
          ...
          <button
            ...
            disabled={isLoading}
            className="flex-1 px-4 py-3 bg-warning text-warning-foreground rounded-lg hover:bg-warning/90 disabled:opacity-50 transition-colors font-medium"
          >
            Maybe
          </button>
          <button
