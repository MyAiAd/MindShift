      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-indigo-50 to-purple-50">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Start with Problem Shifting or unlock the complete MindShift experience. 
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200 flex flex-col h-full">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">Perfect for exploring MindShift</p>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-2 border-indigo-500 relative flex flex-col h-full">
              ...
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Complete MindShift</h3>
              ...
              <ul className="space-y-3 mb-8 flex-grow">
                ...
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" />
                  <span className="text-gray-700">All 7 MindShift methodologies</span>
                </li>
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" />
