        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-xl bg-gradient-to-br from-purple-50 to-violet-50 border border-purple-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Progress Analytics</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div>
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">24/7 AI Assistant</h3>
                    <p className="text-gray-600">
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">AI Coaching Session</h4>
                    <p className="text-sm text-gray-600">Personalized guidance in real-time</p>
                  </div>
                </div>
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-800"><strong>You:</strong> I always feel like everyone is judging me when I speak.</p>
                  </div>
                  <div className="bg-blue-50 p-4 rounded-lg">
