...
function TreatmentSessionContent() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground dark:text-[#93a1a1]">Please sign in to access V3 treatment sessions.</p>
  ...
  if (!sessionId) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-indigo-600"></div>
        <span className="ml-2 text-muted-foreground dark:text-[#93a1a1]">Initializing V3 session...</span>
      </div>
    );
  }
