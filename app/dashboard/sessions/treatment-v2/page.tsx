...
function TreatmentSessionContent() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        ...
        <span className="ml-2 text-gray-600 dark:text-[#93a1a1]">Loading...</span>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-[#93a1a1]">Please sign in to access treatment sessions.</p>
  ...
  if (!sessionId) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-indigo-600"></div>
        <span className="ml-2 text-gray-600 dark:text-[#93a1a1]">Initializing session...</span>
      </div>
    );
  }
