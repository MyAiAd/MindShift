                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Technology that serves human flourishing</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Grounded in psychological research</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Available to everyone, everywhere</p>
                    </div>
                  </div>
                </div>
              </div>
