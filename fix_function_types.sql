-- First, let's check if the function exists at all
SELECT 'Checking if function exists:' as step;
SELECT proname, proargtypes::regtype[] as arg_types 
FROM pg_proc 
WHERE proname = 'get_coach_available_slots';
...
-- Now test with proper type casting
SELECT 'Testing function with proper types:' as step;
