      ...
      steps: [
        {
          ...
          scriptedResponse: (userInput, context) => {
            // PARITY: Match v2 order - prefer originalProblemStatement for integration (first/root problem)
        ...
        },
        {
          ...
          scriptedResponse: (userInput, context) => {
            // PARITY: Match v2 order - prefer originalProblemStatement for intention question
