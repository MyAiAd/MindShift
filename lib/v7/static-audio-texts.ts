/**
 * V7 Static Audio Texts
 * 
 * These are hardcoded text segments from v7 treatment modalities that should be
...
export const V7_STATIC_AUDIO_TEXTS = {
  ...
  // Problem Shifting opener (lib/v7/treatment-modalities/problem-shifting.ts)
  ...
  // Identity Shifting opener (lib/v7/treatment-modalities/identity-shifting.ts)
  ...
  // Belief Shifting opener (lib/v7/treatment-modalities/belief-shifting.ts)
  ...
  // Blockage Shifting opener (lib/v7/treatment-modalities/blockage-shifting.ts)
  ...
  // Reality Shifting opener (lib/v7/treatment-modalities/reality-shifting.ts)
  ...
  // Trauma Shifting opener (lib/v7/treatment-modalities/trauma-shifting.ts)
  TRAUMA_SHIFTING_INTRO: "Please close your eyes and keep them closed throughout the rest of the process.",

  // Method Selection (lib/v7/treatment-modalities/method-selection.ts) - v2 parity
  METHOD_SELECTION: "Choose which Mind Shifting method you would like to use to clear the problem:",

  // Method Selection for Digging Deeper (lib/v7/treatment-modalities/digging-deeper.ts) - v2 parity (no numbered list)
  METHOD_SELECTION_DIGGING: "We need to clear this problem. Which method would you like to use?",

  // Work Type Descriptions (lib/v7/treatment-modalities/work-type-selection.ts)
  ...
  // Reality Shifting Questions (lib/v7/treatment-modalities/reality-shifting.ts)
  ...
  // Discovery Phase (lib/v7/treatment-modalities/discovery.ts)
  ...
  // Digging Deeper (lib/v7/treatment-modalities/digging-deeper.ts)
...
export function getAllUniqueStaticTexts(): string[] {
  const texts = Object.values(V7_STATIC_AUDIO_TEXTS);
