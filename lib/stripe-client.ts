...
if (!process.env.STRIPE_SECRET_KEY) {
  console.warn('⚠️  STRIPE_SECRET_KEY not set - using placeholder key for development');
  console.warn('Set STRIPE_SECRET_KEY environment variable for actual Stripe integration');
}

if (!process.env.STRIPE_WEBHOOK_SECRET) {
  console.warn('⚠️  STRIPE_WEBHOOK_SECRET not set - webhook verification will fail');
  console.warn('Set STRIPE_WEBHOOK_SECRET environment variable for webhook handling');
}
