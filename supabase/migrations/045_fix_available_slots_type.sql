-- Fix the type mismatch error in get_session_stats function
-- The available_slots field needs to be cast to BIGINT to match the return type
...
BEGIN
    ...
    WITH coaching_stats AS (
        ...
        WHERE 
            ...
            AND (scheduled_at >= stats_cleared_at_date)
            AND (
                is_super_admin 
    ...
    treatment_stats AS (
        ...
        WHERE 
            ...
            AND (created_at >= stats_cleared_at_date)
            AND (
                is_super_admin 
    ...
    SELECT 
        ...
        0::BIGINT as available_slots, -- Cast to BIGINT to fix type mismatch
