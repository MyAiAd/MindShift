...
BEGIN
    ...
    SELECT id INTO existing_user_id FROM auth.users WHERE email = 'Sage@MyAi.ad';
    ...
    IF existing_user_id IS NULL THEN
        INSERT INTO auth.users (
            ...
            'authenticated',
            'Sage@MyAi.ad',
            crypt('MindShift123!', gen_salt('bf')),
            NOW(),
            NOW(),
    ...
    ELSE
        ...
        UPDATE auth.users SET 
            encrypted_password = crypt('MindShift123!', gen_salt('bf')),
            updated_at = NOW()
